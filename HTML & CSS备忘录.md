...
<img src="https://raw.githubusercontent.com/zhedieya/MyPics/main/typora-img/image-20221011230931106.png" alt="image-20221011230931106" style="zoom:50%;" />

上图便是个使用场景，当整个标签页的宽度大于标签页容器的宽度时，跳转到超出范围的tab页时，tab页容器要自动滚动到被触发的tab页。
