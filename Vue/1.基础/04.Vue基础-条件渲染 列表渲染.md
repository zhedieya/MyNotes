...
- 开发中如何选择key:
  ...
  2.如果不存在对数据的逆序添加、逆序删除等破坏顺序操作，仅用于渲染列表用于展示，使用index作为key是没有问题的。<img src="/Users/owsl/Desktop/works/notes/图/IMG_3078.jpg" alt="IMG_3078" style="zoom:30%;" align="left" />
